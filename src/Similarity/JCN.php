...
class JCN extends ICSimilarity
{
     ...
     * @return float JCN wordnet similarity metric between two synsets
     */
    function computeSimilarity(SynSet $synSet1, SynSet $synSet2): float
    {
        ...
        return 1 / ($this->informationContents[$synSet1->getId()] + $this->informationContents[$synSet2->getId()] - 2 * $this->informationContents[$LCSid]);
    }
}